 ...
 *
 * Copyright: (c) 2013-2016 WooThemes
 *
...
class WC_Points_Rewards {
	...
	private function includes() {
		...
		// cart / checkout class
		require( 'includes/class-wc-points-rewards-cart-checkout.php' );
		$this->cart = new WC_Points_Rewards_Cart_Checkout();

		// order class
		require( 'includes/class-wc-points-rewards-order.php' );
		$this->order = new WC_Points_Rewards_Order();

		// discount class
		require( 'includes/class-wc-points-rewards-discount.php' );
		$this->discount = new WC_Points_Rewards_Discount();

		// actions class
		require( 'includes/class-wc-points-rewards-actions.php' );
		$this->actions = new WC_Points_Rewards_Actions();

		// manager class
		require( 'includes/class-wc-points-rewards-manager.php' );

		// points log access class
		require( 'includes/class-wc-points-rewards-points-log.php' );
