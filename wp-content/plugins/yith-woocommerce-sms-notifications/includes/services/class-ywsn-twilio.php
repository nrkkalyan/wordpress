        ...
        public function send( $to_phone, $message, $country_code ) {
            ...
            if ( isset( $response['response']['code'] ) ) {
                ...
                if ( $response['response']['code'] != 201 && $response['response']['code'] != 200 ) {
                    ...
                    throw new Exception( ( isset( $response['message'] ) ) ? $response['message'] : __( 'An error has occurred while sending the sms', 'yith-woocommerce-sms-notifications' ) );
                }
