...
if ( ! class_exists( 'YWSN_Metabox' ) ) {
	...
	class YWSN_Metabox {
		...
		public function output() {
			...
			$option = get_post_meta( $_GET['post'], '_ywsn_receive_sms', true );
			...
			<div class="ywsn-sms-metabox">
				...
				<div class="ywsn-char-count"><?php _e( 'Remaining characters', 'yith-woocommerce-sms-notifications' ); ?>: <span>160</span></div>
				</p>
				<p>
		...
		public function save() {
			...
			error_log( $receive_sms );
			update_post_meta( $post->ID, '_ywsn_receive_sms', $receive_sms );
