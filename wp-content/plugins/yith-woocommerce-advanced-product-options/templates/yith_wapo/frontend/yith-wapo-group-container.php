...
<div class="yith_wapo_group_total <?php echo ( get_option( 'yith_wapo_settings_show_add_ons_price_table' , 'no' ) == 'yes' ? 'yith_wapo_keep_show' : '' ) ?>" data-product-price="<?php echo esc_attr( $product->get_display_price() ); ?>" data-product-id="<?php echo esc_attr( $product->id ); ?>">
    <table>
