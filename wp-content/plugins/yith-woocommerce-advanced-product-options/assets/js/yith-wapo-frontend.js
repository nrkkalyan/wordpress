    ...
    $.fn.init_yith_wapo_totals = function() {
        ...
        function changeFeaturedImage(current_group_container, data) {
            ...
            if(allow_to_change){
                ...
                var $product_image = $('.woocommerce-main-image > img.wp-post-image, div.product div.images > img');
                ...
                var $set_image = is_field_selected && $new_image != '' && $new_image != global_product_featured_image && ! current_group_container.hasClass('ywapo_conditional_hidden') && ! current_group_container.hasClass( 'ywapo_conditional_variation_hidden' );
                ...
                if( $set_image ) {
                    ...
                    undoFeaturedImage($product_image , current_group_container  );
        ...
        function cechkMinMaxInputValuesAmount( data ) {
            ...
            if( current_group_container_type == 'number'  ) {
                ...
                var $all_elements = current_group_container.find('input[type="number"].ywapo_input');
                var $selected_values_amount = 0;

                $all_elements.each(function(){
                    var value = $(this).val();
                    if(value!='') $selected_values_amount+=parseInt(value);
                });
                                ...
                                if( has_hided_dependecies ) {
                                    ...
                                    if( typeof current_group_container_id != 'undefined' && current_group_container_id != null ) {
                                        ...
                                        if( is_dependent >= 0 || is_dependent == 'option' ) {
                                            ...
                                            var $is_match = isDependentMatch( current_group_container_id.toString() , current_values , group_container_dependecies , is_dependent );
        ...
        function isDependentMatch( $current_id , $current_values, group_container_dependecies , dependent_type ) {
            'use strict';
