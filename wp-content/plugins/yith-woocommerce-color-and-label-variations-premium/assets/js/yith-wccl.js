...
jQuery(document).ready( function($) {
    ...
    $.yith_wccl = function( attr ) {
        ...
        forms.each(function () {
            ...
            var form    = $(this),
                ...
                image_src       = image.data('lazy-src') != 'undefined' ? image.data('lazy-src') : image.attr( 'src' ),
                image_srcset    = image.data('lazy-srcset') != 'undefined' ? image.data('lazy-srcset') : image.attr( 'srcset' ),
            ...
            form.on( 'found_variation', function (ev, variation) {
                ...
                var var_price = variation.price_html,
    ...
    $(document).on( 'yith-wcan-ajax-filtered yith_infs_added_elem initialized.owl.carousel', function() {
