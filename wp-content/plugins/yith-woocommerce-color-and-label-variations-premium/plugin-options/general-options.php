...
$general = array(
	...
	'general'  => array(
		...
		array(
			...
			'title'     => __( 'Enable plugin in archive page', 'yith-woocommerce-color-label-variations' ),
			'type'      => 'checkbox',
			'desc'      => __( 'Choose to show attribute selection in archive shop page', 'yith-woocommerce-color-label-variations' ),
			'default'   => 'yes'
		),
