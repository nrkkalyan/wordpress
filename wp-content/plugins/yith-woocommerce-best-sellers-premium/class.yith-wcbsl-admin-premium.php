...
if ( !class_exists( 'YITH_WCBSL_Admin_Premium' ) ) {
    ...
    class YITH_WCBSL_Admin_Premium extends YITH_WCBSL_Admin {
        ...
        public function add_options_in_settings_tab( $settings ) {
            $bestseller_limit = YITH_WCBSL_Premium()->get_limit();
            ...
            $premium_settings = array(
                ...
                'update-time'                           => array(
                    'name'    => __( 'Bestseller Update Time', 'yith-wcpsc' ),
                    'type'    => 'select',
                    'desc'    => __( 'Select update time for Best Sellers Reporting', 'yith-wcpsc' ),
                    'id'      => 'yith-wcpsc-update-time',
                    'options' => array(
                        'yesterday' => __( '1 Day', 'yith-wcpsc' ),
                        '7day'      => __( '7 Days', 'yith-wcpsc' ),
                        'month'     => __( 'Solar Month', 'yith-wcpsc' ),
                        'year'      => __( 'Solar Year', 'yith-wcpsc' ),
                        'ever'      => __( 'Unlimited', 'yith-wcpsc' ),
                    ),
                    'default' => '7day'
                ),
                'badge-text'                            => array(
        ...
        public function admin_enqueue_scripts() {
            ...
            wp_enqueue_script( 'yith_wcbsl_admin_js', YITH_WCBSL_ASSETS_URL . '/js/admin.js', array( 'jquery', 'jquery-chosen' ), '1.0.0', true );
        }
        ...
        public function register_plugin_for_activation() {
            if ( !class_exists( 'YIT_Plugin_Licence' ) ) {
                require_once( YITH_WCBSL_DIR . 'plugin-fw/lib/yit-plugin-licence.php' );
            }
        ...
        public function register_plugin_for_updates() {
            if ( !class_exists( 'YIT_Upgrade' ) ) {
                require_once( YITH_WCBSL_DIR . 'plugin-fw/lib/yit-upgrade.php' );
            }
...
function YITH_WCBSL_Admin_Premium() {
    return YITH_WCBSL_Admin_Premium::get_instance();
}
