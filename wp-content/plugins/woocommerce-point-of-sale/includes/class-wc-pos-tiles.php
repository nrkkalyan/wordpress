                        ...
                        <tr class="form-field form-required">
                            ...
                            <td>
                                ...
                                <input type="hidden" id="product_id" name="product_id"
                                       ...
                                       data-selected="<?php echo $selected; ?>" value="<?php echo $value; ?>"/>
                ...
                <div id="col-container">
                    <div id="col-right">
                        <div class="col-wrap">
                            ...
                            <div class="full">
                                <br>
                                <h2><?php _e('Grid Preview ', 'wc_point_of_sale'); ?></h2>
                                <div class="postbox wc-pos-preview-register-grids" id="wc-pos-register-grids">
                                    <h3 class="hndle">
                                        <span><?php _e(ucfirst($grids_single_record[0]->name) . ' Layout', 'wc_point_of_sale') ?></span>
                                    </h3>
                                            ...
                                            foreach ($titles as $title) :
                                                ...
                                                if ($title->style == 'image') :
                                                    ...
                                                    <td id="title_<?php echo $title->ID ?>"
                                                        style="background: url('<?php echo $image; ?>') top no-repeat; background-size: auto 60px; background-color: #fff; vertical-align: bottom;"
                                                        class="title_product">
