    ...
    class WC_Pos_Receipts
    {
        ...
        public static function get_default_receipt_options()
        {
            $receipt_options = array(
                ...
                'customer_name_label' => __('Customer Name', 'wc_point_of_sale'),
                'print_customer_email' => 'yes',
                'customer_email_label' => __('Customer Email', 'wc_point_of_sale'),
                'print_customer_ship_address' => 'yes',
                'customer_ship_address_label' => __('Shipping Address', 'wc_point_of_sale'),
                'show_sku' => '',
                'show_register' => 'yes',
                'show_outlet' => 'yes',
                'show_site_name' => 'yes',
                                        ...
                                        <div class="inside">
                                            <table id="receipt_options">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
	                                                    <input type="number" name="receipt_width" class="form-control bfh-number" id="receipt_width" min="0" max="120" step="5" default="0" value="<?php echo $receipt_options['receipt_width']; ?>"/><span style="margin-left: 10px;">mm</span>
                                        ...
                                        <div class="inside">
                                            <table id="receipt_options">
                                                ...
                                                <tr class="show_receipt_print_outlet_contact_details">
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="contact_position"><?php _e('Address & Contact Position', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                ...
                                <div class="meta-box-sortables">
                                    <div class="postbox ">
                                        <h3 style="border-bottom: 1px solid #eee">
                                            <span><?php _e('Receipt Preview', 'wc_point_of_sale'); ?></span>
                                        </h3>
        ...
        public function get_style_templates()
        {
            ...
            $templates = array(
                ...
                'logo_size' => array(
                    'normal' => '#print_receipt_logo {height: 70px;}',
                    'small' => '#print_receipt_logo {height: 35px;}',
                    'large' => '#print_receipt_logo {height: 140px;}',
                ),
                'logo_position' => array(
                ...
                'contact_position' => array(
                    'left' => '#pos_receipt_address, #pos_receipt_contact {text-align: left;}',
                    'center' => '#pos_receipt_address, #pos_receipt_contact {text-align: center;}',
                    'right' => '#pos_receipt_address, #pos_receipt_contact {text-align: right;}',
                ),
