...
<div class="md-modal md-dynamicmodal md-close-by-overlay" id="modal-opening_cash_amount">
    <div class="md-content woocommerce">
        ...
        <div class="opening-cash-content col3-set">
            ...
            <p class="form-row form-row-wide validate-required">
                <label for="opening_amount_note"><?php _e('Note', 'woocommerce'); ?></label>
                <textarea placeholder="<?php _e('Type to add a note', 'wc_point_of_sale') ?>" id="opening_amount_note" name="opening_amount_note"></textarea>
            </p>
        </div>
