...
class WC_POS_Admin_Setup_Wizard
{
    ...
    public function setup_wizard_header()
    {
		...
		<h2 id="logos">
			<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/ae.svg" alt="Actuality Extensions" />
		</h2>
        <?php
    }
    ...
    public function setup_wizard_footer()
    {
        ...
        <a class="wc-return-to-dashboard"
           href="<?php echo esc_url(admin_url()); ?>"><?php _e('Return to the WordPress Dashboard', 'wc_point_of_sale'); ?></a>
    <?php endif; ?>
        </body>
        </html>
        <?php
    ...
    public function wc_pos_setup_introduction()
    {
        ...
        <p><?php _e('Thank you for choosing WooCommerce Point of Sale to sell your products in-store! This quick setup wizard will help you configure the basic settings.', 'wc_point_of_sale'); ?>
            <b><?php _e('It\'s completely optional and shouldn\'t take longer than five minutes.', 'wc_point_of_sale'); ?></b>
        </p>
        ...
        <p class="wc-setup-actions step">
            <a href="<?php echo esc_url($this->get_next_step_link()); ?>"
               class="button-primary button button-large button-next"><?php _e('Let\'s Go!', 'wc_point_of_sale'); ?></a>
            <a href="<?php echo esc_url(admin_url('plugins.php')); ?>"
               class="button button-large"><?php _e('Not right now', 'wc_point_of_sale'); ?></a>
        </p>
        <?php
    }
        ...
        <form method="post">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" aria-required="true" size="40" style="width: 100%;" id="_outlet_name"
    ...
    public function wc_pos_setup_general_options()
    {
        ...
        ?>
        <p class="store-setup"><?php _e('The following wizard will help you configure your POS and get you started quickly.', 'wc_point_of_sale'); ?></p>
        <form method="post">
            <table class="form-table" cellspacing="0">
                <tbody>
                <tr class="section_title">
    ...
    public function wc_pos_setup_ready()
    {
        ...
        <div class="wc-setup-next-steps">
            <div class="wc-setup-next-steps-first">
                ...
                <ul>
                    <li class="setup-product"><a class="button button-primary button-large"
                                                 href="<?php echo esc_url(admin_url('admin.php?page=wc_pos_registers')); ?>"><?php _e('View and manage your registers!', 'wc_point_of_sale'); ?></a>
                    </li>
                </ul>
            </div>
            <div class="wc-setup-next-steps-last">
                ...
                <ul>
                    <li class="newsletter"><a href="http://eepurl.com/Ybb5j"
                                              target="_blank"><?php _e('Subscribe to our newlsetter', 'wc_point_of_sale'); ?></a>
                    </li>
                    <li class="learn-more"><a href="http://actualityextensions.com/documentation/"
                                              target="_blank"><?php _e('Read more about getting started', 'wc_point_of_sale'); ?></a>
                    </li>
