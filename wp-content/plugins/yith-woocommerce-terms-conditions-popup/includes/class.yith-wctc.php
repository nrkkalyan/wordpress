...
if ( ! class_exists( 'YITH_WCTC' ) ) {
	...
	class YITH_WCTC {
		...
		public function enqueue() {
			...
			$checkout_page = function_exists( 'icl_object_id' ) ? icl_object_id( $checkout_page, 'page', true ) : $checkout_page;
			...
			if( is_page( $checkout_page ) && ! empty( $terms_page ) && get_option( 'yith_wctc_enable_popup' ) == 'yes' ){
