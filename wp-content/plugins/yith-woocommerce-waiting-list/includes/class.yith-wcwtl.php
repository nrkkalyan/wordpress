	...
	class YITH_WCWTL {
		...
		public function __construct() {
			...
			if ( $this->is_admin() ) {
                ...
                require_once( 'class.yith-wcwtl-admin-premium.php' );
                require_once( 'class.yith-wcwtl-custom-table.php' );
                require_once( 'admin-table/class.yith-wcwtl-exclusions-table.php' );
                require_once( 'admin-table/class.yith-wcwtl-waitlistdata-table.php' );
				...
				// admins settings tables
				YITH_WCWTL_Exclusions_Table();
				YITH_WCWTL_Waitlistdata_Table();
				...
				if( defined( 'YITH_WPV_PREMIUM' ) && YITH_WPV_PREMIUM ){
                    // required class
                    require_once( 'compatibility/yith-woocommerce-product-vendors.php' );
