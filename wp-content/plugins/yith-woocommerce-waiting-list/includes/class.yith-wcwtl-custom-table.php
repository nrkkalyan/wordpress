 ...
 *
 */
class YITH_WCWTL_Custom_Table extends WP_List_Table {
    ...
    function column_cb( $item ) {
        ...
        $name = ( isset( $_GET['view'] ) && isset( $_GET['tab'] ) && 'waitlistdata' === $_GET['tab'] && 'users' === $_GET['view'] ) ? 'user_email[]' : 'id[]';
