		...
		public function get_carrier_list() {
			$carriers = array(
				...
				'COURIERSPLEASE'    => array(
					...
					'track_url' => 'https://www.couriersplease.com.au/Tools/Track',
				),
				'UK_MAIL'           => array(
					'name'      => 'UK Mail',
					'track_url' => 'https://www.ukmail.com/manage-my-delivery/manage-my-delivery?con=[TRACK_CODE]',
				...
				'POSTE_IT'          => array(
					'name'      => 'Poste Italiane',
					'track_url' => 'http://www.poste.it/online/dovequando/ricerca.do',
					'form'      => '<form name="POSTE_IT" target="_blank" method="post" action="http://www.poste.it/online/dovequando/ricerca.do"><input id="mpcode1" name="mpcode1" value="[TRACK_CODE]" type="hidden"><input  id="mpcode2" name="mpcode1" value="[TRACK_CODE]"  type="hidden"></form>',
				),
				'EMS_JAPAN'         => array(
					'name'      => 'EMS Japan Post',
			...
			return apply_filters( 'yith_ywot_carrier_list', $carriers );
		}
