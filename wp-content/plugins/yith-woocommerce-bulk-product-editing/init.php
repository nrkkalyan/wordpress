...
if ( ! defined( 'YITH_WCBEP_VERSION' ) ){
    define( 'YITH_WCBEP_VERSION', '1.1.26' );
}
...
function yith_wcbep_pr_init() {
    ...
    require_once('functions.yith-wcbep-premium.php');
    require_once('class.yith-wcbep-admin.php');
    require_once('class.yith-wcbep.php');
    require_once('class.yith-wcbep-admin-premium.php');
    require_once('class.yith-wcbep-premium.php');
