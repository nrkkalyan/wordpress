...
if ( !class_exists( 'YITH_WCBEP_Admin' ) ) {
    ...
    class YITH_WCBEP_Admin {
         ...
         * @since  1.0.0
         */
        public $doc_url = 'https://yithemes.com/docs-plugins/yith-woocommerce-bulk-product-editing';
        ...
        public function action_links( $links ) {
            ...
            $links[] = '<a href="' . admin_url( "admin.php?page={$this->_panel_page}" ) . '">' . __( 'Settings', 'yith-woocommerce-bulk-product-editing' ) . '</a>';
        ...
        public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
            ...
            if ( ( defined( 'YITH_WCBEP_FREE_INIT' ) && YITH_WCBEP_FREE_INIT == $plugin_file ) || ( defined( 'YITH_WCBEP_INIT' ) && YITH_WCBEP_INIT == $plugin_file ) ) {
                $plugin_meta[] = '<a href="' . $this->doc_url . '" target="_blank">' . __( 'Plugin Documentation', 'yith-woocommerce-bulk-product-editing' ) . '</a>';
            }
        ...
        public function register_panel() {
            ...
            $args = array(
                ...
                'parent_slug'      => '',
                'page_title'       => __( 'Bulk Product Editing', 'yith-woocommerce-bulk-product-editing' ),
                'menu_title'       => __( 'Bulk Product Editing', 'yith-woocommerce-bulk-product-editing' ),
        ...
        public function admin_enqueue_scripts() {
            ...
            if ( $is_panel ) {
                ...
                wp_enqueue_script( 'yith_wcbep_main_tab_js', YITH_WCBEP_ASSETS_URL . '/js/' . $main_tab_js, array( 'jquery', 'jquery-ui-resizable' ), YITH_WCBEP_VERSION, true );
