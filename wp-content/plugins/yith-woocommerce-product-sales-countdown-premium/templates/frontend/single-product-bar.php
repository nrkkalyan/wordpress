    ...
    if ( $item['show_bar'] == 'show' ) {
        ...
        <div class="ywpc-sale-bar ywpc-item-<?php echo $id; ?>"<?php echo $style; ?>>
            <div class="ywpc-header"<?php echo $header_css ?>>
                <?php echo get_option( 'ywpc_sale_bar_title', __( 'On sale', 'yith-woocommerce-product-countdown' ) ); ?>
            </div>
            <div class="ywpc-bar">
                <div class="ywpc-back">
                ...
                <div class="ywpc-label">
                    <?php printf( __( '%d/%d Sold', 'yith-woocommerce-product-countdown' ), ( ( !is_rtl() ) ? $item['sold_qty'] : $item['discount_qty'] ), ( ( !is_rtl() ) ? $item['discount_qty'] : $item['sold_qty'] ) ); ?>
                </div>
            </div>
        </div>
