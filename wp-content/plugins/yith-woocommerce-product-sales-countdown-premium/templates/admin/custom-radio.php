                    ...
                    <div class="ywpc-preview">
                        <div class="ywpc-countdown ywpc-item-0">
                            <div class="ywpc-header">
                                <?php _e( 'Sale ends in', 'yith-woocommerce-product-countdown' ); ?>
                            </div>
                        ...
                        <div class="ywpc-sale-bar ywpc-item-0">
                            <div class="ywpc-header" style="width: 34%;">
                                <?php _e( 'On sale', 'yith-woocommerce-product-countdown' ); ?>
                            </div>
                            <div class="ywpc-bar">
                                <div class="ywpc-back">
                                ...
                                <div class="ywpc-label">
                                    <?php
                                    if ( !is_rtl() ) {
                                        printf( __( '%d/%d Sold', 'yith-woocommerce-product-countdown' ), 40, 100 );
                                    }
                                    else {
                                        printf( __( '%d/%d Sold', 'yith-woocommerce-product-countdown' ), 100, 40 );
                                    }
                                    ?>
                                </div>
                            </div>
