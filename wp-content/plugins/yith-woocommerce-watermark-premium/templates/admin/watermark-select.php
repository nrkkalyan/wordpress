        ...
        public static function output( $option )
        {
            ...
            if ($value) {
                foreach ($value as $i => $watermark) {
                    ...
                    $watermark_category = isset($value[$i]['ywcwat_watermark_category']) ? explode(',', $value[$i]['ywcwat_watermark_category']) : array();
                    ...
                    echo yith_wcwat_get_template( 'single-watermark-template.php', $params, true );
