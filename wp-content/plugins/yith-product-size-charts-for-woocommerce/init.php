 ...
 * Plugin URI: http://yithemes.com/docs-plugins/yith-product-size-charts-for-woocommerce/
...
if (! defined('YITH_WCPSC_VERSION')) {
    define('YITH_WCPSC_VERSION', '1.0.10');
}
...
function yith_wcpsc_pr_init()
{
    ...
    require_once ('class.yith-wcpsc-admin-premium.php');
    require_once ('class.yith-wcpsc-frontend-premium.php');
    require_once ('class.yith-wcpsc-premium.php');
