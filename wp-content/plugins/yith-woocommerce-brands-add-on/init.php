<?php
/**
 * Plugin Name: YITH WooCommerce Brands Add-on Premium
...
if ( ! defined( 'YITH_WCBR_VERSION' ) ) {
	define( 'YITH_WCBR_VERSION', '1.0.9' );
}
...
if( ! function_exists( 'yith_wcbr_install_woocommerce_admin_notice' ) ) {
	function yith_wcbr_install_woocommerce_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'YITH WooCommerce Brands Add-on is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-brands-add-on' ); ?></p>
		</div>
	<?php
	}
}
