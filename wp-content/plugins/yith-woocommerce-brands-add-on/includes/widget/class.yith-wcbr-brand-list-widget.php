	...
	class YITH_WCBR_Brand_List_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__( 'YITH Brand List', 'yith-woocommerce-brands-add-on' ),
				array(
					'description' => __( 'Add a list of brands', 'yith-woocommerce-brands-add-on' )
				)
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				...
				<small><?php _e( 'Show number for products for each brand', 'yith-woocommerce-brands-add-on' ) ?></small>
			</p>
			<p>
			...
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
					...
					<option value="small-header" <?php selected( $style, 'small-header' ) ?> ><?php _e( 'Empty', 'yith-woocommerce-brands-add-on' ) ?></option>
					<option value="shadow" <?php selected( $style, 'shadow' ) ?> ><?php _e( 'Shadow', 'yith-woocommerce-brands-add-on' ) ?></option>
					<option value="boxed" <?php selected( $style, 'boxed' ) ?> ><?php _e( 'Round', 'yith-woocommerce-brands-add-on' ) ?></option>
