...
<div class="t-col-12">
  ...
  <div class="box-body">
    ...
    <div class="lineloader"></div>  
      <table class="woocommerce-stock-manager table-bordered">
        <tr>
      ...
      ?>
        ...
        <?php } ?>  
          ...
          <?php WCM_Table::thumbnail_box( $item ); ?>
          ...
          <td></td>
          <?php WCM_Table::table_simple_line( $product_meta, $item, $product_type, $item_product ); ?>
      ...
      ?>
        <tr class="variation-line variation-item-<?php echo $item->ID; ?>">
          <td class="td_center"><input type="checkbox" name="cd[<?php echo $vars->ID; ?>]" /></td>
