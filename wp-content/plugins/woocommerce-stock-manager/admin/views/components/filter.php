      ...
      <div class="filter-display filter-block">
        ...
        <h2><?php _e('Hide or display cells','stock-manager'); ?></h2>
          <table class="table-bordered">
            <tr>
              <td><?php _e('Thumbnail','stock-manager'); ?></td>
            ...
            <tr>
              <td><?php _e('Tax status','stock-manager'); ?></td>
              ...
              <td><?php _e('Tax class','stock-manager'); ?></td>
              ...
              <td><?php _e('Shipping class','stock-manager'); ?></td>
