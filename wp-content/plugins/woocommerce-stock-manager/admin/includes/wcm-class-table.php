...
class WCM_Table {
  ...
  /**
    ...
    public static function table_simple_line( $product_meta, $item, $product_type, $product ){
        ...
        if(!empty( $display_option['tax_status'] ) && $display_option['tax_status'] == 'display' ){
            self::tax_status_box( $product_meta, $item->ID, $product_type );
        }
        if(!empty( $display_option['tax_class'] ) && $display_option['tax_class'] == 'display' ){
        ...
        if(!empty( $display_option['price'] ) && $display_option['price'] == 'display' ){
            self::price_box( $product_meta, $item->ID, $product_type );
        }
        if(!empty( $display_option['sales_price'] ) && $display_option['sales_price'] == 'display' ){
            self::sales_price_box( $product_meta, $item->ID, $product_type ); 
        }
        if(!empty( $display_option['weight'] ) && $display_option['weight'] == 'display' ){
            ...
            if( $product_type == 'variable' ){
                ...
                if( !empty( $variable_stock ) && $variable_stock == 'ok' ){
                    ...
                    <td class="td_center <?php echo $class; ?>" style="width:70px;">
                        <input type="number" name="stock[<?php echo $item->ID; ?>]" step="<?php echo $step; ?>" value="<?php echo $stock_number; ?>" class="stock_<?php echo $item->ID; ?>" style="width:70px;" />
                    </td>
                    <?php
                }else{
                    ...
                    ?>
                    <td class="td_center <?php echo $class; ?>" style="width:70px;">
                        <input type="number" name="stock[<?php echo $item->ID; ?>]" step="<?php echo $step; ?>" value="<?php echo $stock_number; ?>" class="stock_<?php echo $item->ID; ?>" style="width:70px;background:#ffffff;" disabled="disabled" />
                    </td>
                    <?php
                }
            }else{
