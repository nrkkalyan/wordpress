...
//         add_filter('wc_order_statuses', array($this, 'add_order_statuses'), 10, 1);
    ...
    public function admin_enqueue_scripts () {
        ...
        if( in_array($screen->id, array( 'wc_custom_statuses', 'edit-wc_custom_statuses' )) ){
            ...
            wp_localize_script( $this->_token . '-admin-meta-boxes', 'wc_sa_editor_btns', $editor_btns || array() );
            wp_localize_script( $this->_token . '-admin-meta-boxes', 'wc_sa_acf_editor_btns', $acf_btns || array() );
