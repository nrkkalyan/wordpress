	...
	<div class="panel wc_sa_options_panel woocommerce_options_panel" id="customer_options_tab">
		<div class="options_group">
			...
			<p class="form-field show_if_customer_account">
				<label for="status_customer_account_visibility"><?php _e( 'Visibility Rule', 'woocommerce_status_actions' ); ?><span class="required">*</span></label>
	...
	<div class="panel wc_sa_options_panel woocommerce_options_panel" id="action_options_tab">
		<div class="options_group">
			...
			<p class="form-field show_if_automatic_trigger">
				<label for="status_triggered_status"><?php _e( 'Triggered Status', 'woocommerce_status_actions' ); ?><span class="required">*</span></label>
			...
			<p class="form-field show_if_automatic_trigger">
				<label for="status_time_period"><?php _e( 'Time Period', 'woocommerce_status_actions' ); ?><span class="required">*</span></label>
